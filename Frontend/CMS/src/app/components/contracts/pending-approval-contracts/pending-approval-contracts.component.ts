...
@Component({
  ...
  templateUrl: './pending-approval-contracts.component.html',
  styleUrl: './pending-approval-contracts.component.css'
})
export class PendingApprovalContractsComponent implements OnInit {
  displayedColumns: string[] = ['contractID', 'contractName', 'contractType', 'departmentName', 'effectiveDate',
      ...
      GetAllContracts(pageNumber: number, pageSize: number) {
          this.contractsService.getPendingApprovalContracts(pageNumber, pageSize).subscribe({
