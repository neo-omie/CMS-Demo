...
import { AddEmployeeDto } from '../../models/master-employee';
...
export class AddEmployeeComponent {
  ...
  constructor(private router:Router, private departmentService:MasterDepartmentService, private employeeService: MasterEmployeeService){}
