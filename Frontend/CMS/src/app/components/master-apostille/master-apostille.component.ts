...
export class MasterApostilleComponent {
  ...
  constructor(
    private apostilleService: MasterApostilleService,
  ...
  fetchApostille() {
    this.apostilleService
      .getApostilles(this.currentPage, this.pageSize, this.searchTerm)
      .subscribe({
  ...
  deleteApostille(apostille: MasterApostille) {
    ...
    Alert.confirmToast(
      'Are you sure you want to delete this Apostille?',
      ...
      () => {
        this.apostilleService
          .deleteApostille(apostille.valueId, empCode)
          .subscribe({
  ...
  onSubmit() {
    ...
    if (this.mode === 'add') {
      ...
      console.log(addFormValues);
      this.apostilleService
        .updateApostille(this.apoID, addFormValues, empCode)
        .subscribe({
