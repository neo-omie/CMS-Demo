...
END
EXEC SP_GetAllClassifiedContracts @PageNumber = 1, @PageSize = 10

-- Get Classified Contract By ID
CREATE OR ALTER PROCEDURE SP_GetClassifiedContractByID @ID int
AS
BEGIN
	SELECT c.ClassifiedContractId as ClassifiedContractId, c.ClassifiedContractName as ClassifiedContractName,
	...
	WHERE c.ClassifiedContractId = @ID;
END
EXEC SP_GetClassifiedContractByID @ID = 1